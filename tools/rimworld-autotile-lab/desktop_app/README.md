...
- organic terrain geometry controls: `contour_warp_px` adds map-space contour noise, `rim_width`, `edge_debris`, `colors.edge`, and `edge_color_strength` control the visible cliff lip, and `normal_detail_strength` adds height relief for dynamic lighting
