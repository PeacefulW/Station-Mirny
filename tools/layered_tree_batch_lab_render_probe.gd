...
const ASSET_ROOT: String = "res://artifacts/layered_tree_nw_winter_batch_proof/candidates"
const OUTPUT_DIR: String = "res://artifacts/layered_tree_nw_winter_batch_proof/lab"
...
func _run() -> void:
	...
	for tree_index: int in range(2, 7):
	...
	report.close()
	print("layered_tree_batch_lab_render_probe: wrote %d captures" % _snapshots.size())
	quit(0)
