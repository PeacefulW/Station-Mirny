...
Canonical holding area for unresolved lore.
...
- undecided twists
- alternative content directions

Rule:
- unresolved lore must not silently become architecture truth
- if system behavior depends on a lore assumption, that assumption must be explicitly marked

## Current open questions migrated from legacy GDD
...
If one of these questions starts affecting:
- system design
