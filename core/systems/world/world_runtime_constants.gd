...
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_DENSITY: int = 44
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_SCATTER_GRID_SIDE: int = 45
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_EDGE_PADDING_PX: int = 46
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_MIN_DISTANCE_PX: int = 47
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_MAX_PER_CHUNK: int = 48
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_MIN_SIZE_PX: int = 49
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_MAX_SIZE_PX: int = 50
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_GRASS_DENSITY_MIN: int = 51
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_GRASS_DENSITY_MAX: int = 52
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_GRASS_FIELD_SCALE_PX: int = 53
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_GRASS_COVERAGE: int = 54
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_ROCK_FIELD_SCALE_PX: int = 55
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_ROCK_COVERAGE: int = 56
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_MACRO_MASS_SCALE_PX: int = 57
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_MACRO_MASS_STRENGTH: int = 58
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_PATH_SCALE_PX: int = 59
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_PATH_WIDTH: int = 60
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_PATH_WARP_PX: int = 61
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_PATH_STRENGTH: int = 62
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_ASSET_VARIANT_COUNT: int = 63
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_CLUSTER_RADIUS_PX: int = 64
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_CLUSTER_MIN_COUNT: int = 65
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_CLUSTER_MAX_COUNT: int = 66
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_CLUSTER_MIN_DISTANCE_PX: int = 67
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_EDGE_BIAS: int = 68
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_ROCKY_PATCH_BIAS: int = 69
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_PATH_EDGE_BIAS: int = 70
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_FIELD_COUNT: int = 71

## Second stone placement set: same block layout, own values, own block start.
## It owns open ground; the first set stays tuned for the grass edge.
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_BLOCK_BEGIN: int = 44
const SETTINGS_PACKED_LAYOUT_SMALL_ROCK_BLOCK_STRIDE: int = 27
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_BLOCK_BEGIN: int = 71
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_DENSITY: int = 71
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_SCATTER_GRID_SIDE: int = 72
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_EDGE_PADDING_PX: int = 73
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_MIN_DISTANCE_PX: int = 74
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_MAX_PER_CHUNK: int = 75
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_MIN_SIZE_PX: int = 76
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_MAX_SIZE_PX: int = 77
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_GRASS_DENSITY_MIN: int = 78
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_GRASS_DENSITY_MAX: int = 79
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_GRASS_FIELD_SCALE_PX: int = 80
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_GRASS_COVERAGE: int = 81
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_ROCK_FIELD_SCALE_PX: int = 82
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_ROCK_COVERAGE: int = 83
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_MACRO_MASS_SCALE_PX: int = 84
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_MACRO_MASS_STRENGTH: int = 85
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_PATH_SCALE_PX: int = 86
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_PATH_WIDTH: int = 87
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_PATH_WARP_PX: int = 88
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_PATH_STRENGTH: int = 89
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_ASSET_VARIANT_COUNT: int = 90
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_CLUSTER_RADIUS_PX: int = 91
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_CLUSTER_MIN_COUNT: int = 92
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_CLUSTER_MAX_COUNT: int = 93
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_CLUSTER_MIN_DISTANCE_PX: int = 94
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_EDGE_BIAS: int = 95
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_ROCKY_PATCH_BIAS: int = 96
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_PATH_EDGE_BIAS: int = 97
const SETTINGS_PACKED_LAYOUT_BARE_GROUND_STONE_FIELD_COUNT: int = 98
