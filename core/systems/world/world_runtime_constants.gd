...
const CONTOUR_HALO_TILES: int = 2
const CONTOUR_RENDER_TILE_SIZE_PX: int = 32

const CONTOUR_CLASS_GROUND_SURFACE: StringName = &"ground_surface"
const CONTOUR_CLASS_MOUNTAIN_MASS: StringName = &"mountain_mass"
const CONTOUR_CLASS_WATER_SURFACE: StringName = &"water_surface"
const CONTOUR_CLASSES: Array = [
	CONTOUR_CLASS_MOUNTAIN_MASS,
	CONTOUR_CLASS_GROUND_SURFACE,
	CONTOUR_CLASS_WATER_SURFACE,
]
const CONTOUR_ACTIVE_RESULT_CLASSES: Array = [
	CONTOUR_CLASS_MOUNTAIN_MASS,
	CONTOUR_CLASS_GROUND_SURFACE,
]

const CONTOUR_CLASS_EMPTY_CODE: int = 0
const CONTOUR_CLASS_GROUND_CODE: int = 1
const CONTOUR_CLASS_MOUNTAIN_CODE: int = 2
const CONTOUR_CLASS_WATER_CODE: int = 3

const CONTOUR_SOURCE_EMPTY: int = 0
const CONTOUR_SOURCE_LOADED_DIFF: int = 1
const CONTOUR_SOURCE_LOADED_PACKET: int = 2
const CONTOUR_SOURCE_UNLOADED_DIFF: int = 3
const CONTOUR_SOURCE_GENERATED_BASE: int = 4
const CONTOUR_SOURCE_OUT_OF_WORLD: int = 5
