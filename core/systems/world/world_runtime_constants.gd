...
const WORLD_VERSION: int = 15
const WORLD_FOUNDATION_VERSION: int = 9
const RIVER_GENERATION_VERSION: int = 15
...
const TERRAIN_LAKEBED_SHALLOW: int = 7
const TERRAIN_LAKEBED_DEEP: int = 8
const TERRAIN_OCEAN_BED_SHALLOW: int = 9
const TERRAIN_OCEAN_BED_DEEP: int = 10
...
const SETTINGS_PACKED_LAYOUT_RIVER_AMOUNT: int = 15
const SETTINGS_PACKED_LAYOUT_LAKE_DENSITY_SCALE: int = 16
const SETTINGS_PACKED_LAYOUT_LAKE_RADIUS_SCALE: int = 17
const SETTINGS_PACKED_LAYOUT_MOUTH_WIDTH_SCALE: int = 18
const SETTINGS_PACKED_LAYOUT_BED_WIDTH_SCALE: int = 19
const SETTINGS_PACKED_LAYOUT_FIELD_COUNT: int = 20
