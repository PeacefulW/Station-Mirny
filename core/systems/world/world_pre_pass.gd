...
func sample_all(world_pos: Vector2i) -> Dictionary:
	return {
		...
		DRAINAGE_CHANNEL: sample(DRAINAGE_CHANNEL, world_pos),
		RIDGE_STRENGTH_CHANNEL: sample(RIDGE_STRENGTH_CHANNEL, world_pos),
		MOUNTAIN_MASS_CHANNEL: sample(MOUNTAIN_MASS_CHANNEL, world_pos),
		SLOPE_CHANNEL: sample(SLOPE_CHANNEL, world_pos),
		RAIN_SHADOW_CHANNEL: sample(RAIN_SHADOW_CHANNEL, world_pos),
		CONTINENTALNESS_CHANNEL: sample(CONTINENTALNESS_CHANNEL, world_pos),
	}
