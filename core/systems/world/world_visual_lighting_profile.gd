...
const MIN_OBJECT_SHADOW_SOFTNESS_TEXELS: float = 0.75
const MAX_OBJECT_SHADOW_SOFTNESS_TEXELS: float = 7.0
const OBJECT_SHADOW_BILINEAR_GUARD_TEXELS: float = 1.0
