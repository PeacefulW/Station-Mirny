...
Ориентир: ~200-300 строк. Если файл > 300 — подумай можно ли разделить. Если нельзя без потери читаемости — 350 допустимо. Файл > 400 — обязательно декомпозировать..
