...
def main() -> None:
    if len(sys.argv) != 5:
        raise SystemExit("Usage: python make_rock_2_spritesheet.py <frames_dir> <sheet_png> <metadata_json> <columns>")
    ...
    frame_paths = sorted(frames_dir.glob("rock_2_rot_*_*.png"))
    if not frame_paths:
