...
- Log: `C:/Users/peaceful/Station Peaceful/Station Peaceful/debug_exports/perf/runtime_far_loop_postfix8_seed12345.log`
- Lines: `38307`
- Errors: `1`
- Warnings: `10`

## Boot metrics
- `Startup.loading_screen_visible_to_startup_bubble_ready_ms`: `24944.99 ms`
- `Startup.start_to_loading_screen_visible_ms`: `13.30 ms`
- `Startup.startup_bubble_ready_to_boot_complete_ms`: `15398.62 ms`
...
## WorldPrePass phases
- `WorldPrePass.compute.rain_shadow`: `978.27 ms`
- `WorldPrePass.compute.flow_accumulation`: `873.04 ms`
- `WorldPrePass.compute.flow_directions`: `669.93 ms`
- `WorldPrePass.compute.lake_aware_fill`: `556.05 ms`
- `WorldPrePass.compute.slope_grid`: `426.20 ms`
- `WorldPrePass.compute.spine_seeds`: `414.37 ms`
- `WorldPrePass.compute.erosion_proxy`: `327.01 ms`
- `WorldPrePass.compute.sample_height_grid`: `148.76 ms`
- `WorldPrePass.compute.ridge_strength_grid`: `60.39 ms`
- `WorldPrePass.compute.ridge_graph`: `47.01 ms`
- `WorldPrePass.compute.continentalness`: `38.64 ms`
- `WorldPrePass.compute.mountain_mass_grid`: `29.35 ms`

## WorldPrePass subphases
- `WorldPrePass.compute.lake_aware_fill.extract_lake_records`: `550.49 ms`
- `WorldPrePass.compute.continentalness.seed_water_sources`: `27.68 ms`
- `WorldPrePass.compute.river_extraction.seed_river_sources`: `15.55 ms`
- `WorldPrePass.compute.continentalness.distance_propagation`: `5.89 ms`
- `WorldPrePass.compute.lake_aware_fill.priority_flood`: `5.36 ms`
- `WorldPrePass.compute.river_extraction.distance_propagation`: `4.50 ms`
...
## Recent warnings
- `WARNING: [Boot] apply step for (0, 0) took 8.5 ms (budget 8.0 ms)`
- `WARNING: [Boot] apply step for (0, -1) took 9.6 ms (budget 8.0 ms)`
- `WARNING: [Boot] apply step for (1, 0) took 11.5 ms (budget 8.0 ms)`
- `WARNING: [Boot] apply step for (63, 0) took 10.8 ms (budget 8.0 ms)`
...
- `WARNING: [Boot] apply step for (1, 1) took 12.2 ms (budget 8.0 ms)`
- `WARNING: [Boot] apply step for (63, 1) took 8.8 ms (budget 8.0 ms)`
...
- `[WorldPerf] scheduler.visual_queue_depth.full_far: 348.00 ms`
- `[WorldPerf] FrameBudgetDispatcher.visual.chunk_manager.streaming_redraw: 10.27 ms`
...
- `[WorldPerf] scheduler.visual_queue_depth.full_near: 2.00 ms`
- `[WorldPerf] scheduler.visual_queue_depth.full_far: 348.00 ms`
- `[WorldPerf] FrameBudgetDispatcher.visual.chunk_manager.streaming_redraw: 8.80 ms`
- `[WorldPerf] FrameBudgetDispatcher.total: 8.95 ms`
...
- `[WorldPerf] scheduler.visual_queue_depth.full_near: 2.00 ms`
- `[WorldPerf] scheduler.visual_queue_depth.full_far: 348.00 ms`
- `[WorldPerf] FrameBudgetDispatcher.visual.chunk_manager.streaming_redraw: 8.85 ms`
- `[WorldPerf] FrameBudgetDispatcher.total: 8.99 ms`
