...
- Do not write directly to `SaveManager.current_slot`, `SaveManager.is_busy`, or pending-load internals. Use public safe entry points from `PUBLIC_API.md`.
- Any save/load semantic change requires a contract/API documentation check before closure.
