...
struct Snapshot {
	...
	std::vector<float> mountain_clearance_distance_tiles;
	std::vector<float> floodplain_potential;
	int32_t river_segment_count = 0;
	int32_t river_source_count = 0;
	bool river_density_zero_trunk_suppressed = false;
	...
	std::vector<float> river_discharge_normalized;
	...
	int32_t lake_sdf_continuity_lake_count = 0;
	int32_t lake_outlet_continuation_node_count = 0;
	int32_t lake_inlet_widened_shore_node_count = 0;
	int32_t lake_sdf_mountain_clipped_node_count = 0;
	...
	int32_t mountain_clearance_blocked_node_count = 0;
	int32_t mountain_water_overlap_tile_count = 0;
	int32_t river_tiles_adjacent_to_mountain_count = 0;
	int32_t lake_tiles_adjacent_to_mountain_count = 0;
	int32_t river_mouths_without_terminal_widening_count = 0;
	int32_t rivers_with_cut_endpoint_count = 0;
	int32_t overview_runtime_classifier_mismatch_count = 0;
	int32_t river_width_profile_edge_count = 0;
	int32_t river_source_taper_edge_count = 0;
	int32_t river_terminal_expansion_edge_count = 0;
	int32_t river_confluence_width_profile_edge_count = 0;
	int32_t river_ford_narrowing_edge_count = 0;
	int32_t estuary_delta_fan_terminal_count = 0;
	int32_t estuary_delta_fan_edge_count = 0;
	int32_t estuary_discharge_fan_branch_count = 0;
	int32_t estuary_coast_sdf_modified_node_count = 0;
	int32_t estuary_mountain_blocked_branch_count = 0;
	float estuary_terminal_fan_width_ratio_max = 0.0f;
